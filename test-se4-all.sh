# nohup time ./testCoarse.bash ../models-acl2010 ../se4-coarse/eng-coarse-all-words.xml ../results/se4-all-coarse-again.result ../WordNet-1.7.1/dict/index.sense &> nohup-test-se4-all.out &
...
# nohup time ./testCoarse.bash ../models-omsti ../se4-coarse/eng-coarse-all-words.xml ../results/se4-all-coarse-omsti.result ../WordNet-1.7.1/dict/index.sense &> nohup-test-omsti-se4-all.out &
